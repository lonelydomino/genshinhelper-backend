...
Character.create(name: "Fischl", vision: "electro", rarity: 4).image.attach(io: File.open("#{path}fischl.png"), filename: 'diluc.png')
...
Character.create(name: "Kaeya", vision: "cryo", rarity: 4).image.attach(io: File.open("#{path}kaeya.png"), filename: 'jean.png')
